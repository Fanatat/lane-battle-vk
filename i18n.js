...
const I18N = {
  ru: {
    ...
    rotatePrompt: 'Поверните телефон — игре нужна альбомная ориентация',
    pauseTitle: 'Пауза',
    ...
    scoutIncoming: 'Разведка: дальше — {role}',
  ...
  en: {
    ...
    rotatePrompt: 'Rotate your device — the game needs landscape orientation',
    pauseTitle: 'Paused',
    ...
    scoutIncoming: 'Scouted ahead: {role}',
